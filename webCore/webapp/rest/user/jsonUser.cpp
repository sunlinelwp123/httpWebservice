...
bool JsonUser::jsonStringParseUser(const char *jsonStr){
...
void JsonUser::printUser(){
		cout << this << "@" <<cJSON_Print(userJson) << endl;/*输出json数据需要转成json字符串*/
	}
